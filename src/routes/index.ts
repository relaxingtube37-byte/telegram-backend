...
import { adminLimiter, postbackLimiter } from '../middlewares/rateLimiter';
...
router.use('/api/postback', postbackLimiter, postbackRoutes);
router.use('/postback', postbackLimiter, postbackRoutes);
router.use('/api/webhook/postback', postbackLimiter, postbackRoutes);
router.use('/webhook/postback', postbackLimiter, postbackRoutes);
